...
class SpamHam:
    ...
    def main_window(self):
        ...
        #mid_label 
        mid_label=Label(self.window,bg=BG_COLOR,fg="#0000FF",text="Spam Or NonSpam ? Message Detector",
    ...
    def on_enter(self,event):
        ...
        self.answer.config(fg="#ff0000",text="Your message is : "+
                           ("spam" if self.classifier.predict(self.bow(message)).reshape(1,-1) else "nonspam"))
